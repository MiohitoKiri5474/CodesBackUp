...
int n, m, discard, unused = 0;
bool taken[105][105];

inline void push_A ( int d ) {
	/*
	  O
	  O
	  O
	...
	*/
	...
	bool check = false;
	int pos = m - 1;
	while ( !taken[d][pos] && !taken[d + 1][pos] && !taken[d + 2][pos] && !taken[d + 3][pos] && pos )
		pos--, check = true;
	...
	while ( taken[d][pos] || taken[d + 1][pos] || taken[d + 2][pos] || taken[d + 3][pos] )
		pos++;

	taken[d][pos] = taken[d + 1][pos] = taken[d + 2][pos] = taken[d + 3][pos] = true;
	unused -= 4;
}

inline void push_B ( int d ) {
	/*
	  OOO
	*/
	...
	bool check = false;
	int pos = m - 3;
	while ( !taken[d][pos] && !taken[d][pos + 1] && !taken[d][pos + 2] && pos )
		pos--, check = true;
	...
	while ( taken[d][pos] || taken[d][pos + 1] || taken[d][pos + 2] )
		pos++;

	taken[d][pos] = taken[d][pos + 1] = taken[d][pos + 2] = true;
	unused -= 3;
}

inline void push_C ( int d ) {
	/*
	  OO
	  OO
	*/
	...
	bool check = false;
	int pos = m - 2;
	while ( !taken[d][pos] && !taken[d][pos + 1] && !taken[d + 1][pos + 1] && !taken[d + 1][pos] && pos )
		pos--, check = true;
	...
	while ( taken[d][pos] || taken[d][pos + 1] || taken[d + 1][pos + 1] || taken[d + 1][pos] )
		pos++;

	taken[d][pos] = taken[d][pos + 1] = taken[d + 1][pos] = taken[d + 1][pos + 1] = true;
	unused -= 4;
}

inline void push_D ( int d ) {
	/*
	 	 O
	   OOO
	*/
	...
	bool check = false;
	int pos = m - 3;
	while ( !taken[d][pos + 2] && !taken[d + 1][pos] && !taken[d + 1][pos + 1] && !taken[d + 1][pos + 2] && pos )
		pos--, check = true;
	...
	while ( taken[d][pos + 2] || taken[d + 1][pos] || taken[d + 1][pos + 1] || taken[d + 1][pos + 2] )
		pos++;

	taken[d][pos + 2] = taken[d + 1][pos] = taken[d + 1][pos + 1] = taken[d + 1][pos + 2] = true;
	unused -= 4;
}

inline void push_E ( int d ) {
	/*
	   O
	  OO
	  OO
	*/
	...
	bool check = false;
	int pos = m - 2;
	while ( !taken[d][pos + 1] && !taken[d + 1][pos] && !taken[d + 1][pos + 1] && !taken[d + 2][pos] && !taken[d + 2][pos + 1] && pos )
		pos--, check = true;
	...
	while ( taken[d][pos + 1] || taken[d + 1][pos] || taken[d + 1][pos + 1] || taken[d + 2][pos] || taken[d + 2][pos + 1] )
		pos++;

	taken[d][pos + 1] = taken[d + 1][pos] = taken[d + 1][pos + 1] = taken[d + 2][pos] = taken[d + 2][pos + 1] = true;
	unused -= 5;
}
...
int main() {
	...
	while ( q-- ) {
		cin >> c >> d;
		switch ( c ) {
			case 'A': push_A ( d ); break;
			case 'B': push_B ( d ); break;
			case 'C': push_C ( d ); break;
			case 'D': push_D ( d ); break;
			case 'E': push_E ( d ); break;
			default: puts ( "???" );
		}
	}

	cout << unused << ' ' << discard << endl;
}
